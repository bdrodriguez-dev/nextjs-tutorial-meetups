...
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("IF/j");
 // .../api/new-meetup
...
const handler = async (req, res) => {
  if (req.method === "POST") {
    ...
    try {
      const result = await Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_0__[/* connectToMongoDBAndRunQuery */ "a"])(collection => {
